...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 ?><a href="change_pass.php">change password</a> | <a href="edit_profile.php">Edit Profile</a> | <a href="log_off.php?action=logoff">sign out</a>
		</div></td>
		<p>
			<?php
			...
			<form id="editprofileForm" action="edit_profile_submit.php" method="post">
				<table width="80%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<span class="label">Current: <?= $getuser[0]['email']; ?></span></td>
					</tr>
					<tr>
