				...
				<div class="col-md-9">
					...
					<div class="thumbnail">
						...
						<div class="caption-full">
							...
							<h4><a href="#">Login do systemu</a></h4>
								...
								<form id="regForm" action="reg_submit.php" method="post">
									<table align="center" width="50%" cellspacing="1" cellpadding="1" border="0">
										...
										<tr>
											...
											<td>
											<input onclick="this.value='';" name="email" type="text" size="25" maxlength="50" value="<?php
										...
										<tr>
											<td><label for="manager">Manager mail:</label></td>
											<td>
											<input onclick="this.value='';" name="manager" type="text" size="25" maxlength="50" value="<?php
												if (isset($_POST['manager'])) {echo $_POST['manager'];
												}
											?>"/>
											</td>
										</tr>
										<tr>
											...
											<img id="loading" style="width:120px; height:120px;" src="images/loading.gif" alt="working.." /></td>
										</tr>
										<tr>
											<td colspan="2">
											<div id="error">
